    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
        <div class="container-fluid">
        	<a href="/bbs/board/list?p=1&f=&q=">
            	<img src="/bbs/img/grlogo.png" alt="Logo" style="height:60px;" class="rounded-3 mx-2">
           	</a>
        ...
        <div class="row">
            ...
            <div class="col-6">
            	<div class="d-flex justify-content-between">
            		...
            		<div><a class="nav-link" href="/bbs/board/list?p=1&f=&q="><i class="fa-solid fa-house"></i> Home</a></div>
            	</div>
                <hr>
